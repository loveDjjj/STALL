...
> 历史文档：本清单记录早期 release refactor 的文件决策，不是当前仓库清单。
> 当前目录职责见 `docs/PROJECT_ORGANIZATION.md` 和根目录 `FILE_STRUCTURE.md`。
...
| `tools/verify_alpha_stalled_release.py` | 兼容入口；实现归档于pre-release assets，当前U0使用`verify_u0_locked_release.py` |
