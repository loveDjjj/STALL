...
from .release_io import sha256_file, write_json


CONTRACT_SCHEMA_VERSION = "alpha_stalled_feature_cache_contract_v1"
ENTRY_SCHEMA_VERSION = "alpha_stalled_feature_cache_entry_v1"
CONTRACT_FILENAME = ".alpha_stalled_cache_contract.json"
...
def _extractor_source_hashes(cache_kind: str) -> dict[str, str]:
    ...
    paths = [
        package_root / "backbone.py",
        package_root / "video_io.py",
        source_root / "stall.py",
    ]
    if cache_kind == "patch_embeddings":
        paths.append(source_root / "stall_patch.py")
